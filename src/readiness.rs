...
const TFTP_ROOT: &str = "/var/cache/cybex-pulse/tftp";
const IPXE_AUTOEXEC_FILENAME: &str = "autoexec.ipxe";
const IPXE_AUTOEXEC_PACKAGE_PATH: &str = "/usr/share/cybex-pulse/autoexec.ipxe";
const IPXE_AUTOEXEC_BODY: &[u8] =
    include_bytes!("../ubuntu-appliance/rootfs/usr/share/cybex-pulse/autoexec.ipxe");
...
mod tests {
    ...
    #[test]
    fn ipxe_chain_script_uses_the_dhcp_pulse_and_normalized_mac_path() {
    ...
    fn staged_ipxe_chain_script_requires_exact_root_owned_shape_and_bytes() {
        let root = std::env::temp_dir().join(format!(
            "cybex-pulse-readiness-ipxe-script-{}",
